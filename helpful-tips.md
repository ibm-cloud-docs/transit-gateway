...
* Known restriction: New transit gateways support 4-way ECMP, but existing gateways can't use this feature unless you [open a support case](/docs/get-support?topic=get-support-sr-creating) for assistance.
...
* The default number of unique base networks that can be targeted by unbound GRE tunnels is limited to five. You can open an [IBM Support case](/docs/get-support?topic=get-support-sr-creating) if you need these service limits expanded.
...
You can open an [IBM Support case](/docs/get-support?topic=get-support-sr-creating) if you need your service limits expanded.
{: note}
