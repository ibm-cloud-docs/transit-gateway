...
1. Click the name of the transit gateway that you want to delete.
1. Ensure that the transit gateway has no attached connections - if it does, delete all connections.
