...
{{site.data.keyword.tg_full_notm}} is integrated into the [IBM Cloud usage dashboard](/docs/billing-usage?topic=billing-usage-usage-table), which provides a summary of estimated charges for all services and resources that are used per month in your organizations. This includes the number of connections and the amount of traffic flowing across your transit gateways. {{site.data.keyword.tg_full_notm}} usage is billed and reported as part of the [IBM Cloud invoice process](/docs/billing-usage?topic=billing-usage-invoice).
 
### Are there notifications through email for events of unavailability of the service?
{: faq}
{: #service-unavailability-notifications}
 
When the service is unavailable, use the standard [IBM Cloud notification process](/docs/account?topic=account-notifications-email) for any maintenance events.
