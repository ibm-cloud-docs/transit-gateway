...
On 23 August 2021, some Activity Tracker events for IBM Cloud Transit Gateway changed. For details and required actions, see the [IBM Cloud announcement](https://www.ibm.com/blog/announcement/the-ibm-cloud-transit-gateway-service-is-changing-ibm-cloud-activity-tracker-events/){: external}.
{: important}
