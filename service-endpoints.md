...
# Using service endpoints to privately connect to Transit Gateway
{: #service-endpoints}
...
## Setting up service endpoints for Transit Gateway
{: #endpoint-setup}
...
## Disabling public service endpoints for Transit Gateway
{: #endpoint-disable}
