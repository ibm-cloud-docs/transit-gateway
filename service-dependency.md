...
The following dependencies apply to the following deployment locations: Dallas (us-south), Frankfurt (eu-de), London (eu-gb), Madrid (eu-es), Mumbai - Airtel (in-mum), Osaka (jp-osa), Sao Paulo (br-sao), Sydney (au-syd), Tokyo (jp-tok), Toronto (ca-tor), Washington DC (us-east).
...
{: row-headers}
{: caption="IBM Cloud Transit Gateway - Data plane deployment service dependency information - Critical dependencies" caption-side="top"}
...
{: row-headers}
{: caption="IBM Cloud Transit Gateway - Data plane deployment service dependency information - Significant dependencies" caption-side="top"}
...
{: row-headers}
{: caption="IBM Cloud Transit Gateway - Data plane deployment service dependency information - Minimal dependencies" caption-side="top"}
...
{: row-headers}
{: caption="IBM Cloud Transit Gateway - Control plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-transit-Control-plane-deployment"}
{: class="comparison-tab-table"}
...
| {{site.data.keyword.cis_full}} | Availability, configuration-management, Customer responsibility, Operations | No | control-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
...
|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| SysDig| Access management, Change management, Operations, Security compliance | No | control-plane |  Same region  |
...
{: row-headers}
{: caption="IBM Cloud Transit Gateway - Control plane deployment service dependency information - Medium dependencies" caption-side="top"}
{: tab-title="Medium dependencies"}
{: tab-group="service-dependency-data-for-transit-Control-plane-deployment"}
{: class="comparison-tab-table"}
...
{: row-headers}
{: caption="IBM Cloud Transit Gateway - Control plane deployment service dependency information - Minimal dependencies" caption-side="top"}
{: tab-title="Minimal dependencies"}
{: tab-group="service-dependency-data-for-transit-Control-plane-deployment"}
{: class="comparison-tab-table"}
...
{: row-headers}
{: caption="IBM Cloud Transit Gateway - NGDC data plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-transit-NGDC-data-plane-deployment"}
{: class="comparison-tab-table"}
{: #critical-deps-ngdc-data-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| Oculus Automation API | Availability, Instance control, Operations | No | ngdc-data-plane |  Same data center  |
...
| IBM Cloud Global Resource Catalog | Availability, Change management, Instance control, Security compliance | No | ngdc-data-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
{: caption="IBM Cloud Transit Gateway - NGDC data plane deployment service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-transit-NGDC-data-plane-deployment"}
{: class="comparison-tab-table"}
{: #significant-deps-ngdc-data-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
{: row-headers}
{: caption="IBM Cloud Transit Gateway - NGDC data plane deployment service dependency information - Minimal dependencies" caption-side="top"}
{: tab-title="Minimal dependencies"}
{: tab-group="service-dependency-data-for-transit-NGDC-data-plane-deployment"}
{: class="comparison-tab-table"}
{: #minimal-deps-ngdc-data-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
